...
summary: En savoir plus sur les ports que Trident utilise pour communiquer. 
---
= Ports Trident
:hardbreaks:
:allow-uri-read: 
...
NOTE: Le port de la sonde de liveness/readiness peut être modifié lors de l'installation à l'aide du  `--probe-port` flag. Il est important de s'assurer que ce port n'est pas utilisé par un autre processus sur les worker nodes.
