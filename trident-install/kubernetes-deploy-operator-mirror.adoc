...
.Avant de commencer
Connectez-vous à l'hôte Linux et vérifiez qu'il gère un système fonctionnel et link:../trident-get-started/requirements.html["cluster Kubernetes pris en charge"] que vous disposez des privilèges nécessaires.
