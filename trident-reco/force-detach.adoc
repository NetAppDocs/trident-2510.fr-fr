...
NOTE: Vous pouvez également utiliser d'autres méthodes pour détecter les défaillances de nœud, comme spécifié dans la section link:force-detach.html#integrating-custom-node-health-check-solutions["Intégration de solutions personnalisées de vérification de l'état des nœuds"] ci-dessous.
