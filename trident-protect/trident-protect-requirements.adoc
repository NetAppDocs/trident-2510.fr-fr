...
* Assurez-vous qu’au moins un VolumeSnapshotClass existe. Pour plus d'informations, consultez link:../trident-reference/objects.html#kubernetes-volumesnapshotclass-objects["VolumeSnapshotClass"].
