...
+-------------+-----------+--------+-----------------+--------------------------+-------------+
----
. Restaurez l'application sur le cluster de destination en utilisant le nom AppVault et le chemin d'accès à l'archive : REMARQUE : Lorsque vous utilisez une CR, assurez-vous que l'espace de noms destiné à la restauration de l'application existe sur le cluster de destination.
